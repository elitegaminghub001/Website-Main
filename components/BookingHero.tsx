      ...
      <div className="container-custom relative z-10 py-24">
        ...
        >
          ...
          <h1 className="text-6xl lg:text-7xl font-black mt-8">
            ...
            Book Your
            <span className="neon-text"> Gaming Session</span>

          </h1>

          <p className="text-gray-300 text-lg leading-8 mt-7 max-w-2xl mx-auto">
            Choose your gaming setup, number of players and preferred
            time. Send your booking request directly to Elite Gaming Hub.
          </p>
